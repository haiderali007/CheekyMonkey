...
public class GuestProfileTask extends AsyncTask<String, String, String> {
    ...
    public GuestProfileTask(Context context, String parameter, String serverIP,
    ...
    protected String doInBackground(String... params) {
        ...
        response = BaseNetwork.obj().postMethodWay(serverIP, "", BaseNetwork.ECABS_GUEST_SIGN_UP, parameter);
    ...
    protected void onPostExecute(String response) {
        ...
        iCallBack.responseGuestSave(response);
        if (progressBar != null) {
