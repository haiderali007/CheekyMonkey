 ...
 */
public class BillSplitAdapter1 extends ArrayAdapter<OrderItem> {

    BillSplitLayout billBillBillSplitLayout;
    private Context c;
    private int layout_id;
    private ArrayList<OrderItem> bill_split_list;

    public BillSplitAdapter1(Context context, int textViewResourceId,
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        BillSplitViewHolder holder;
        if (convertView == null) {

            holder = new BillSplitViewHolder();
            ...
            holder.im_b.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    billBillBillSplitLayout.onclick_remove_1(v);
                }
            });
            ...
            holder = (BillSplitViewHolder) convertView.getTag();
        }

        holder.obj_class = bill_split_list.get(position);
    ...
    public static class BillSplitViewHolder {
