...
public class KitchenActivity extends FragmentActivity implements View.OnClickListener,
    ...
    KitchenBarFragment kitchenBarFragment;
    ...
    public void showHome(){
        ...
        if (NetworkUtil.getConnectivityStatus(this) != 0 && errorMsg.isEmpty()){
            ...
            kitchenBarFragment = KitchenBarFragment.newInstance(NotificationFragment.TYPE_ACCEPTED);
            transaction.replace(R.id.container, kitchenBarFragment);
            transaction.commit();
            currentBackListener = kitchenBarFragment ;
        ...
        return new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                switch (position){
                    ...
                    case 0:
                        if (currentBackListener instanceof KitchenBarFragment)
                            ...
                            new Handler().postDelayed(new Runnable() {
                                ...
                                public void run() {
                                    FragmentManager fragmentManager = getSupportFragmentManager();
                                    fragmentManager.beginTransaction().replace(R.id.container, kitchenBarFragment).commit();
                                    currentBackListener = kitchenBarFragment ;
                                    slide_me.closeLeftSide();
                                }
                            }, 200);
...
/*                            // Pin Pointing address on Map
 ...
 /*           case R.id.img_unlock:
            ...
            case R.id.img_refresh:
                ...
                ItemsFragment fragment = kitchenBarFragment.adapter.fragment;
            ...
            case R.id.layout_noti:
                ...
                if (PrefHelper.getStoredBoolean(context,PrefHelper.PREF_FILE_NAME,PrefHelper.STEWARD_LOGIN)){
                    showNotificationFor(KitchenBarFragment.ARGS_GUEST_ORDER_STATUS);
                }else{
                    showHomeItemList();
    ...
    public void onBackPressed() {
        ...
        else if (!(currentBackListener instanceof KitchenBarFragment))
    ...
    public void removeFragmentFromStack() {
        ...
        FragmentTransaction transaction = fmOther.beginTransaction();
        kitchenBarFragment = KitchenBarFragment.newInstance(NotificationFragment.TYPE_ACCEPTED);
        transaction.replace(R.id.container, kitchenBarFragment).commit();
        currentBackListener = kitchenBarFragment;
    }
...
*/
        ...
        Intent intent = new Intent(KitchenActivity.this,IntroductionScreen.class);
        startActivity(intent);
        finish();
    }
    ...
    public void sendNotification(String text) {
        ...
        PendingIntent contentIntent = PendingIntent.getActivity(this, 0,
                new Intent(this, KitchenActivity.class), PendingIntent.FLAG_ONE_SHOT);
